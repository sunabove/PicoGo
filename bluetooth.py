...
def process_json_cmd( s, robot ) :
    try :
        process_json_cmd_imp( s, robot )
    except Exception as e :
        print( e ) 
    pass
pass
    
def process_json_cmd_imp( s, robot ) :
    uart = robot.uart
...
while True :
    ...
    if data_len > 0 :
        data = read_bytes( uart, data_len )  
    pass

    # read end of transmission
    if True : 
        byte_list = read_bytes( uart, 1 )  
